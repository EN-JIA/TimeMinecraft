...
import enchia.time.main.entity.renderer.SpikeRenderer;
...
public class SpikeEntity extends TimeModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("time:rune_land").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("time:a_100tree_1").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("time:a_100_tree_2").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("time:ancient_forest_small").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("time:ancient_rain_forest").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("time:bamboo_boime").equals(event.getName()))
			biomeCriteria = true;
