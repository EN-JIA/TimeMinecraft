...
public class MCY100HugeForestBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public MCY100HugeForestBiome(TimeModElements instance) {
		super(instance, 2407);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-13369600).withGrassColor(-10027264).build();
				...
				event.getRegistry().register(biome.setRegistryName("time:mcy_100_huge_forest"));
			}
		}
	}
