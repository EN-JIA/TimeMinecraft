...
public class MCY100SmallForestBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public MCY100SmallForestBiome(TimeModElements instance) {
		super(instance, 2395);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("time:mcy_100_small_forest"));
			}
		}
	}
